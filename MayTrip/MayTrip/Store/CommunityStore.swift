...
class CommunityStore {
    var posts: [Post] = [
        ...
        Post(id: 3, title: "가제", text: "본문", author: User(id: 17, nickname: "가명", profileImage: nil, email: "test@test.com", exp: 0, provider: "email"), images: ["appLogo", "appLogo", "appLogo", "appleLogo", "appleLogo"], category: "여행후기", tripRoute: nil, createAt: Date(), reply: 0, store: 0),
        Post(id: 4, title: "가제", text: "본문", author: User(id: 17, nickname: "가명", profileImage: nil, email: "test@test.com", exp: 0, provider: "email"), images: [], category: "여행후기", tripRoute: nil, createAt: Date(), reply: 0, store: 0),
        Post(id: 5, title: "가제", text: "본문", author: User(id: 17, nickname: "가명", profileImage: nil, email: "test@test.com", exp: 0, provider: "email"), images: [], category: "여행후기", tripRoute: nil, createAt: Date(), reply: 0, store: 0),
    ]
